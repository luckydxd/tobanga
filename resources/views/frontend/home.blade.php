            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="categories__item categories__large__item set-bg"
                        data-setbg="{{ asset('me') }}/img/home-2.jpg">
                        <div class="categories__text">
                            <h3>Toko Online Outdoor Indramayu</h3>
                            <a style="color:rgba(255, 255, 255, 0.944)" href="{{ route('product.index') }}">Jelajahi Sekarang</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">

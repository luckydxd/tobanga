            ...
            @component('components.backend.card.card-table')
                ...
                <div class="card-header-action">
                    ...
                    {{-- <div
                        ...
                        <a href="" 
                        onclick="this.href='/exportpdf/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value"
                        target="_blank" class="btn btn-primary mt-1">Cetak Laporan</a>
                    </div>
                    </div>
                ...
                @slot('tbody')
                    @foreach ($data['order'] as $order)
                        <tr>
                            ...
                            <td>@currency ($order->total_pay)</td>

    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::prefix('feature')->name('feature.')->group(function(){
            ...
            Route::prefix('order')->name('order.')->group(function(){
                ...
                Route::get('/laporan-pdf/{tglawal}/{tglakhir}',[OrderController::class,'exportpdf']);
...
Route::get('/exportpdf/{tglawal}/{tglakhir}',[OrderController::class,'exportpdf'])->name('exportpdf');

Route::get('/linkstorage', function () {
    Artisan::call('storage:link');
});

// Route::get('/exportpdf{tglawal}/{tglakhir}','OrderController@exportpdf')->name('exportpdf');
